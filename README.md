...
#### Incident Management Tools
  ...
  * [Demisto](https://www.demisto.com/product/) - Demisto community edition offers full Incident lifecycle management, Incident Closure Reports, team assignments and collaboration, and many integrations to enhance automations, like Active Directory, PagerDuty, Jira and much more.
...
#### Windows Evidence Collection
  ...
  * [Binaryforay](http://binaryforay.blogspot.co.il/p/software.html) - list of free tools for win forensics.
  ...
  * [RegRipper](https://code.google.com/p/regripper/wiki/RegRipper) - Regripper is an open source tool, written in Perl, for extracting/parsing information, keys, values, and data from the Registry and presenting it for analysis.
